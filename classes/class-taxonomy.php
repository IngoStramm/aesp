...
class AESP_Taxonomy
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_or_remove_items'        => sprintf(__('Add or Remove %ss', 'aesp'), $this->name),
            ...
            'parent_item'                => sprintf(__('Parent %s:', 'aesp'), $this->name),
            ...
            'new_item_name'              => sprintf(__('New %s', 'aesp'), $this->name),
            'all_items'                  => sprintf(__('All %ss', 'aesp'), $this->name),
            'separate_items_with_commas' => sprintf(__('Separate %ss with comma', 'aesp'), $this->name),
            'choose_from_most_used'      => sprintf(__('Choose from %ss most used', 'aesp'), $this->name)
        );
