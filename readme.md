...
- AESP (Nome do plugin)
- aesp (nome dos arquivos, nome do text domain e slug da url do repositório)
- AESP_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- aesp_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do AESP, através do próprio sistema de atualizações do WordPress
